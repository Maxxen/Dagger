...
export class ShaderProgramInfo {
  ...
  constructor(gl : WebGLRenderingContext, program : WebGLProgram, attributes : {[key : string] : string}, uniforms : {[key : string] : string}){
    ...
    for (var key in uniforms){
      ...
      if(location) {
        ...
        alert("Error, could not get location of uniform: '" + uniforms[key] + "'")
      }
    }
  }
}